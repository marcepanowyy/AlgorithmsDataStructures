# Mowimy ze ciag liczb jest typu MR jesli najpierw jest sccisle malejacy a potem scisle rosnacy,
# albo jesli jest tylko malejacy lub tylko sclisle rosnacy. Prosze zaimplementowac funkcje

# def nr(I)

# ktora majac na wejsciu ciag liczb X = [x1, x2, ... xn-1] zwraca jeden z jego najdluzszych podciagow typu MR

# Przyklad. Dla wejscia [4, 10, 5, 1, 5, 2, 3, 4] wynikime jest [10, 5, 1, 2, 3, 4]. Dla wejscia [1, 10, 5]
# poprawnymi wynikami sa zarowno [1, 10], [1, 5], jak i [10, 5]
