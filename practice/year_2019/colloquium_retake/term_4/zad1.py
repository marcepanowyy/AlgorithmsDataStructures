# [2pkt.] Zadanie 1. (O CHUJ CHODZI?)

# Mówimy, że punkt (x, y) słabo dominuje punkt (x′, y′) jeśli x ≤ x′oraz y ≤ y′(w szczególnościkażdy punkt słabo dominuje samego siebie).
#  Dana jest tablica P zawierająca n punktów. Proszę zaimplementować funkcję dominance(P), która zwraca tablicę S taką, że:
...
# wynikiem jest, między innymi:  S = [ 1, 4, 2 ]
