...
# kilka klocków innym dzieciom tak, żeby jego wieża była najwyższa.
#
# Proszę podać algorytm rozwiązujący ten problem, który zabiera minimalną ilość klocków.

# chyba mozna to w nlogn
